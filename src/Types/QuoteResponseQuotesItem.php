...
class QuoteResponseQuotesItem extends JsonSerializableType
{
    ...
    /**
     * @var ?value-of<QuoteResponseQuotesItemType> $type Normalised insurance category used to group and filter quotes. Always one of `TPL`, `TPL +`, or `Comprehensive`.
     */
    #[JsonProperty('type')]
    public ?string $type;
     ...
     *   type?: ?value-of<QuoteResponseQuotesItemType>,
