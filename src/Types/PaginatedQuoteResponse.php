...
class PaginatedQuoteResponse extends JsonSerializableType
{
    /**
     * @var ?int $currentPage
     */
    ...
    /**
     * @var ?QuoteRequestAggregates $aggregates
     */
    #[JsonProperty('aggregates')]
    public ?QuoteRequestAggregates $aggregates;
     ...
     *   to?: ?int,
     *   total?: ?int,
     *   aggregates?: ?QuoteRequestAggregates,
     * } $values
     */
